# Description: This file is used to create a docker image for React Native Android development.
# Author: @GennadySX
# Date: 07.07.2024
...
#ENV JAVA_HOME=/usr/lib/jvm/java-17-openjdk-arm64/ # if your system is macOS
...
RUN echo "----- -- - -- - - -java home:: $(echo $JAVA_HOME)"
